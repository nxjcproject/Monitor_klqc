...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--贴标签处--%>
     <%--开关量--%>  
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_LT8300L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; top: 347px; left: 284px; position:absolute;color:#4cff00;text-align:right; height: 17px; "></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_LT8300L02_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; top: 351px; left: 756px; position:absolute;color:#4cff00;text-align:right; height: 17px; "></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_LT8300L03_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; top: 351px; position:absolute;color:#4cff00;text-align:right; height: 17px; right: 439px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_LT8300L04_R >DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; top: 352px; left: 1266px; position:absolute;color:#4cff00;text-align:right; height: 17px; "></div>
